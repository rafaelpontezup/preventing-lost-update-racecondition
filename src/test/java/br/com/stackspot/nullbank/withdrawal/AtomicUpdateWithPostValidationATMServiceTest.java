...
class AtomicUpdateWithPostValidationATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private AtomicUpdateWithPostValidationATMService atomicUpdateWithPostValidationATMService;
