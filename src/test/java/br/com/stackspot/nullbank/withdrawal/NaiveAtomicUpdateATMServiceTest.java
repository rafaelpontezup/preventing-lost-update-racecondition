...
class NaiveAtomicUpdateATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private NaiveAtomicUpdateATMService naiveAtomicUpdateATMService;
