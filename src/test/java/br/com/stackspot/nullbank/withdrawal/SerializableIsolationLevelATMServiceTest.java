...
class SerializableIsolationLevelATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private SerializableIsolationLevelATMService serializableIsolationLevelATMService;
