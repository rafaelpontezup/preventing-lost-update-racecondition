...
class AtomicUpdateWithReturningClauseATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private AtomicUpdateWithReturningClauseATMService atomicUpdateWithReturningClauseATMService;
