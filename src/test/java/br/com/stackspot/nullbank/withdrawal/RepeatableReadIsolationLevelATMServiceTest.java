...
class RepeatableReadIsolationLevelATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private RepeatableReadIsolationLevelATMService repeatableReadIsolationLevelATMService;
