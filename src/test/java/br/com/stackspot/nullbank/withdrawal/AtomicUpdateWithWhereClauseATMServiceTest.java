...
class AtomicUpdateWithWhereClauseATMServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private AtomicUpdateWithWhereClauseATMService atomicUpdateWithWhereClauseATMService;
